...
const Main = ()=>{
    return(
        ...
        <Toolbar />
        <div style={{ width:'100%',backgroundColor:'white', padding:'0em 1em 0em 1em', borderRadius:'10px' }}><h1 style={{ borderBottom:'2px solid lightblue' }}>University Exam Scheduling using AI.</h1>
        <img src='https://www.controleng.com/wp-content/uploads/sites/2/2021/12/ai_brain_NL_crped-1024x441.png' alt='temporaryImage' width={'100%'}/>
